...
Isolates are a concurrency mechanism used in [Google Dart](https://dartlang.org). Isolates are spawned and use [message passing](#Message Passing). They are inspired by Erlang's [green processes](#Green Processes).
